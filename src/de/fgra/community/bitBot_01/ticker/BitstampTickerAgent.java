...
public class BitstampTickerAgent extends TickerAgent {
	...
	protected void setup(){
		...
		setTickerName("BitstampTicker");
		setTickerType("price-ticker");
		setTickInt(5000);
		bitstamp = ExchangeFactory.INSTANCE.createExchange("com.xeiam.xchange.bitstamp.BitstampExchange");
